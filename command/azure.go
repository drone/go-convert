...
import (
	...
	"github.com/jamie-harness/go-convert/convert/azure"
...
func (*Azure) Synopsis() string { return "converts a azure pipeline" }
func (*Azure) Usage() string {
	return `azure [-downgrade] [azure-pipelines.yml]
`
}

func (c *Azure) SetFlags(f *flag.FlagSet) {
...
func (c *Azure) Execute(_ context.Context, f *flag.FlagSet, _ ...interface{}) subcommands.ExitStatus {
	path := f.Arg(0)
	...
	// convert the workflow from the azure
