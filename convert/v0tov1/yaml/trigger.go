...
type (
	// Trigger defines a v1 trigger configuration.
	// The trigger structure remains mostly unchanged from v0,
	// only the inputYaml content is converted to v1 format.
	Trigger struct {
	...
	// TriggerConfig is the root wrapper for v1 trigger YAML.
