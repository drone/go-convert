...
type Runtime struct {
	...
	Shell      *RuntimeShell      `json:"shell,omitempty"`
}

// RuntimeShell defines the shell/local/docker runtime configuration.
type RuntimeShell struct {
	Connector string `json:"connector,omitempty" yaml:"connector,omitempty"`
}

// IsShell returns true if the runtime is configured for shell execution.
func (v *Runtime) IsShell() bool {
	return v != nil && v.Shell != nil
}

// MarshalJSON implement the json.Marshaler interface.
func (v Runtime) MarshalJSON() ([]byte, error) {
	if v.Shell != nil {
		if v.Shell.Connector == "" {
