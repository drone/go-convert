...
type ExpressionConvertRequest struct {
	...
	RemoteFile    string `protobuf:"bytes,5,opt,name=remote_file,json=remoteFile,proto3" json:"remote_file,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExpressionConvertRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ExpressionConvertRequest) GetExpressions() []string {
	if x != nil {
		return x.Expressions
	}
	return nil
...
func (x *ExpressionConvertRequest) GetContextPipelineYaml() string {
	if x != nil {
		return x.ContextPipelineYaml
	}
	return ""
...
func (x *ExpressionConvertResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ExpressionConvertResponse) GetExpressions() map[string]string {
	if x != nil {
		return x.Expressions
	}
	return nil
...
func (x *ExpressionConvertResponse) GetChecksum() string {
	if x != nil {
		return x.Checksum
	}
	return ""
...
func (x *ExpressionConvertResponse) GetRemoteFile() string {
	if x != nil {
		return x.RemoteFile
	}
	return ""
...
// ExpressionConvertBatchRequest converts a batch of remote files in a single
// call. The context_pipeline_yaml is applied as shared context to every file,
// so the server builds the FQN step lookup once and reuses it across all files.
type ExpressionConvertBatchRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Map of caller-defined file identifier (e.g. file path) to the raw file
	// content containing embedded <+...>/${{...}} expressions.
	RemoteFiles map[string]string `protobuf:"bytes,1,rep,name=remote_files,json=remoteFiles,proto3" json:"remote_files,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Optional v1 pipeline YAML applied as shared context to every file.
	ContextPipelineYaml string `protobuf:"bytes,2,opt,name=context_pipeline_yaml,json=contextPipelineYaml,proto3" json:"context_pipeline_yaml,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *ExpressionConvertBatchRequest) Reset() {
	*x = ExpressionConvertBatchRequest{}
	mi := &file_go_convert_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExpressionConvertBatchRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExpressionConvertBatchRequest) ProtoMessage() {}

func (x *ExpressionConvertBatchRequest) ProtoReflect() protoreflect.Message {
	mi := &file_go_convert_service_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExpressionConvertBatchRequest.ProtoReflect.Descriptor instead.
func (*ExpressionConvertBatchRequest) Descriptor() ([]byte, []int) {
	return file_go_convert_service_proto_rawDescGZIP(), []int{9}
}

func (x *ExpressionConvertBatchRequest) GetRemoteFiles() map[string]string {
	if x != nil {
...
func (x *ExpressionConvertBatchRequest) GetContextPipelineYaml() string {
	if x != nil {
		return x.ContextPipelineYaml
	}
	return ""
...
// ExpressionConvertBatchResponse is the response for ConvertExpressionBatch.
type ExpressionConvertBatchResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Map of the same file identifier to its converted file content.
	RemoteFiles map[string]string `protobuf:"bytes,1,rep,name=remote_files,json=remoteFiles,proto3" json:"remote_files,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Aggregated non-fatal diagnostics collected across all files.
	Warnings      []string `protobuf:"bytes,2,rep,name=warnings,proto3" json:"warnings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ExpressionConvertBatchResponse) Reset() {
	*x = ExpressionConvertBatchResponse{}
	mi := &file_go_convert_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExpressionConvertBatchResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExpressionConvertBatchResponse) ProtoMessage() {}

func (x *ExpressionConvertBatchResponse) ProtoReflect() protoreflect.Message {
	mi := &file_go_convert_service_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExpressionConvertBatchResponse.ProtoReflect.Descriptor instead.
func (*ExpressionConvertBatchResponse) Descriptor() ([]byte, []int) {
	return file_go_convert_service_proto_rawDescGZIP(), []int{10}
}

func (x *ExpressionConvertBatchResponse) GetRemoteFiles() map[string]string {
	if x != nil {
		return x.RemoteFiles
	}
	return nil
...
func (x *ExpressionConvertBatchResponse) GetWarnings() []string {
	if x != nil {
		return x.Warnings
	}
	return nil
...
const file_go_convert_service_proto_rawDesc = "" +
	...
	"\x1dExpressionConvertBatchRequest\x12r\n" +
	"\fremote_files\x18\x01 \x03(\v2O.io.harness.pms.conversion.proto.ExpressionConvertBatchRequest.RemoteFilesEntryR\vremoteFiles\x122\n" +
	"\x15context_pipeline_yaml\x18\x02 \x01(\tR\x13contextPipelineYaml\x1a>\n" +
	"\x10RemoteFilesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xf1\x01\n" +
	"\x1eExpressionConvertBatchResponse\x12s\n" +
	"\fremote_files\x18\x01 \x03(\v2P.io.harness.pms.conversion.proto.ExpressionConvertBatchResponse.RemoteFilesEntryR\vremoteFiles\x12\x1a\n" +
	...
	"\x0eConvertTrigger\x12/.io.harness.pms.conversion.proto.ConvertRequest\x1a0.io.harness.pms.conversion.proto.ConvertResponse\x12\x8a\x01\n" +
	"\x11ConvertExpression\x129.io.harness.pms.conversion.proto.ExpressionConvertRequest\x1a:.io.harness.pms.conversion.proto.ExpressionConvertResponse\x12\x99\x01\n" +
	"\x16ConvertExpressionBatch\x12>.io.harness.pms.conversion.proto.ExpressionConvertBatchRequest\x1a?.io.harness.pms.conversion.proto.ExpressionConvertBatchResponse\x12r\n" +
...
var file_go_convert_service_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_go_convert_service_proto_goTypes = []any{
	...
	(*ExpressionConvertBatchRequest)(nil),  // 12: io.harness.pms.conversion.proto.ExpressionConvertBatchRequest
	(*ExpressionConvertBatchResponse)(nil), // 13: io.harness.pms.conversion.proto.ExpressionConvertBatchResponse
	nil,                                    // 14: io.harness.pms.conversion.proto.ConvertRequest.TemplateRefMappingEntry
	nil,                                    // 15: io.harness.pms.conversion.proto.ConvertRequest.PipelineRefMappingEntry
	nil,                                    // 16: io.harness.pms.conversion.proto.ConverterMessage.ContextEntry
	nil,                                    // 17: io.harness.pms.conversion.proto.ExpressionConvertResponse.ExpressionsEntry
	nil,                                    // 18: io.harness.pms.conversion.proto.ExpressionConvertBatchRequest.RemoteFilesEntry
	nil,                                    // 19: io.harness.pms.conversion.proto.ExpressionConvertBatchResponse.RemoteFilesEntry
}
var file_go_convert_service_proto_depIdxs = []int32{
	...
	14, // 1: io.harness.pms.conversion.proto.ConvertRequest.template_ref_mapping:type_name -> io.harness.pms.conversion.proto.ConvertRequest.TemplateRefMappingEntry
	15, // 2: io.harness.pms.conversion.proto.ConvertRequest.pipeline_ref_mapping:type_name -> io.harness.pms.conversion.proto.ConvertRequest.PipelineRefMappingEntry
	1,  // 3: io.harness.pms.conversion.proto.ConverterMessage.severity:type_name -> io.harness.pms.conversion.proto.Severity
	16, // 4: io.harness.pms.conversion.proto.ConverterMessage.context:type_name -> io.harness.pms.conversion.proto.ConverterMessage.ContextEntry
	...
	17, // 9: io.harness.pms.conversion.proto.ExpressionConvertResponse.expressions:type_name -> io.harness.pms.conversion.proto.ExpressionConvertResponse.ExpressionsEntry
	18, // 10: io.harness.pms.conversion.proto.ExpressionConvertBatchRequest.remote_files:type_name -> io.harness.pms.conversion.proto.ExpressionConvertBatchRequest.RemoteFilesEntry
	19, // 11: io.harness.pms.conversion.proto.ExpressionConvertBatchResponse.remote_files:type_name -> io.harness.pms.conversion.proto.ExpressionConvertBatchResponse.RemoteFilesEntry
	3,  // 12: io.harness.pms.conversion.proto.GoConvertService.ConvertPipeline:input_type -> io.harness.pms.conversion.proto.ConvertRequest
	3,  // 13: io.harness.pms.conversion.proto.GoConvertService.ConvertTemplate:input_type -> io.harness.pms.conversion.proto.ConvertRequest
	3,  // 14: io.harness.pms.conversion.proto.GoConvertService.ConvertInputSet:input_type -> io.harness.pms.conversion.proto.ConvertRequest
	3,  // 15: io.harness.pms.conversion.proto.GoConvertService.ConvertTrigger:input_type -> io.harness.pms.conversion.proto.ConvertRequest
	10, // 16: io.harness.pms.conversion.proto.GoConvertService.ConvertExpression:input_type -> io.harness.pms.conversion.proto.ExpressionConvertRequest
	12, // 17: io.harness.pms.conversion.proto.GoConvertService.ConvertExpressionBatch:input_type -> io.harness.pms.conversion.proto.ExpressionConvertBatchRequest
	...
	11, // 23: io.harness.pms.conversion.proto.GoConvertService.ConvertExpression:output_type -> io.harness.pms.conversion.proto.ExpressionConvertResponse
	13, // 24: io.harness.pms.conversion.proto.GoConvertService.ConvertExpressionBatch:output_type -> io.harness.pms.conversion.proto.ExpressionConvertBatchResponse
	9,  // 25: io.harness.pms.conversion.proto.GoConvertService.GetChecksum:output_type -> io.harness.pms.conversion.proto.ChecksumResponse
